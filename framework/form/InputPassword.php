...
class InputPassword extends FormElement implements FormElementsInterface
{
  ...
  public function __construct(string $name, ?Label $label, string|int $value = "", array $attributes = [])
  {
    ...
    array_push($this->allowed_attribtutes, 'type', 'minlength', 'maxlength', 'pattern', 'autocomplete');
